...
// ── Config ──────────────────────────────────────────────────────────────────
const RPC_URL     = "https://sepolia.infura.io/v3/f0e9af63d05c4f25b758d24320d7959c"; // for FHE SDK
const RPC_URL_2   = "https://ethereum-sepolia-rpc.publicnode.com"; // fallback for ethers provider
...
const EPOCH_SECONDS = 600; // 10 minutes — FHE encrypt takes ~90s per call, need headroom
...
async function main() {
  ...
  // index 1 of the HD path — different address from index-0 (which matches PRIVATE_KEY)
